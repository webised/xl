...
function nimmo_socials_share_default() { ?>
    <div class="entry-social">
        ...
        <a class="tw-social hover-effect" title="<?php echo esc_attr__('Twitter', 'nimmo'); ?>" target="_blank" href="https://twitter.com/home?status=<?php the_permalink(); ?>"><i class="zmdi zmdi-twitter"></i></a>
