...
<div id="<?php echo esc_attr($html_id) ?>" class="ct-blog-carousel default owl-carousel nav-middle <?php echo esc_attr($el_class); ?>" <?php echo !empty($carousel_data) ?  esc_attr($carousel_data) : '' ?>>
