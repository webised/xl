...
<?php 
        ...
        jQuery(document).ready(function($) { 
					/*$('.sf-menu > li > .menu-item-object-page').on('click', function (e) {
							console.log($(this).attr('data-slide'));
							var element = $(this).attr('data-slide');
								var speed = 750;
	...
	jQuery(document).ready(function($) {  
		...
		jQuery('#nav a[href^="<?php echo $home_url[0]; ?>"]:not(.separate)').click(function (e) {  
			...
			var element = document.getElementById(jQuery(this).attr('data-slide'));
			var header = $('header[role="banner"]');
			var offsetHeight = -50;
            ...
            if(jQuery(divID).length){
		      ...
		      /*window.scrollTo(divID, {duration:<?php echo of_get_option('qs_scrollto_speed', '1300'); ?>, easing:'<?php echo of_get_option('qs_scrollto_easing', 'swing'); ?>', offset:offsetHeight, axis:'y' }, {queue:false});*/
			}
