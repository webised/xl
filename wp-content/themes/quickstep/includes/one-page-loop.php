...
$template_dir = dirname(get_bloginfo('stylesheet_url')); ?>
	  ...
	  $first_loop = true;
		...
		while (have_posts()) : the_post(); 
             ...
             <div class="vertical-wrapper <?php the_ID(); ?>" id="block-<?php the_ID(); ?>">
              	...
              	<div id="container-<?php the_ID(); ?>" data-name="<?php echo $post->post_name; ?>" class="container <?php if($first_loop) echo 'first'; ?>">
					...
					<?php
						if (get_the_ID() == 7)
						  echo '<div class="vertical-wrapper"><div class="container">'.do_shortcode('[metaslider id="33"]').'</div></div>';
					 ?>
              <?php
