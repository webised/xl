...
class CMS_Taxonomy_Meta
{
    ...
    function panel_scripts()
    {
        ...
        wp_enqueue_style('cms-metabox', casethemescore()->path('APP_URL') . '/assets/css/metabox' . Redux_Functions::isMin() . '.css', array(), self::$version, 'all');
        wp_enqueue_script('cms-metabox', casethemescore()->path('APP_URL') . '/assets/js/metabox' . Redux_Functions::isMin() . '.js', array('jquery', 'redux-js'), self::$version, 'all');
