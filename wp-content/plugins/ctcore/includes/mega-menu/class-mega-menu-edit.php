...
class EFramework_Mega_Menu_Edit_Walker extends Walker_Nav_Menu_Edit {
	...
	function get_fields( $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$enable_ongpage_option = apply_filters( 'cms_enable_onepage', true );
		...
		<?php if ( $check_mega ): ?>
            <p class="description description-wide">
                <label for="edit-menu-item-cms-icon-<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <select id="edit-menu-item-cms-icon-<?php echo esc_attr( $item_id ); ?>"
                            class="widefat cms-icon-picker"
            ...
            <p class="description description-wide">
                <label for="menu-item-cms-onepage<?php echo esc_attr( $item_id ); ?>">
                    ...
                    <select id="menu-item-cms-onepage-<?php echo esc_attr( $item_id ); ?>"
                        ...
                        <option value="item-one-page" <?php selected( esc_attr( $item->cms_onepage ), 'item-one-page' ) ?>><?php esc_html_e( 'Yes', CMS_TEXT_DOMAIN ) ?></option>
                    </select>
                </label>
            </p>
		<?php endif; ?>
