	...
	<div class="cms-dashboard-inner clearfix">
		<div class="cms-dashboard-item">
			<div class="cms-dashboard-item-inner">
				...
				<h3><?php echo esc_html__('Automatic Updates', CMS_TEXT_DOMAIN)?></h3>
				<p><?php echo esc_html__('Latest features, demos and more at your fingertips', CMS_TEXT_DOMAIN)?></p>
				<a href="#" target="_blank"><?php echo esc_html__('Check for Updates', CMS_TEXT_DOMAIN)?><i class="dashicons-before dashicons-arrow-right-alt2"></i></a>
